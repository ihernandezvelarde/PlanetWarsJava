...
constraint pk_Planet_Defenses primary key (ID_Planet, ID_Defense, Lvl_attack, Lvl_defense))';
execute immediate crear;
...
Lvl_attack int not null,
Lvl_defense int not null,
constraint pk_Planet_Ship primary key (ID_Planet, ID_Ship, Lvl_attack, Lvl_defense))';
execute immediate crear;
...
Wastings_metal int not null,
Wastings_deuterium int not null,
Winner int not null,
